...
public class ControlbookApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(ControlbookApplication.class, args);
		
		
	}

	@Override  //esse metodo vindo do CommandLineRunner vai ser executado sempre que o app vir a ser startado  
